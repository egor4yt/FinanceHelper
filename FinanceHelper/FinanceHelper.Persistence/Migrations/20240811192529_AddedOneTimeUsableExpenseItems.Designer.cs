...
namespace FinanceHelper.Persistence.Migrations
{
    ...
    [Migration("20240811192529_AddedOneTimeUsableExpenseItems")]
    partial class AddedOneTimeUsableExpenseItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceHelper.Domain.Entities.ExpenseItem", b =>
                {
                    ...
                    b.Property<bool>("OneTimeUsable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasComment("Expense item used in one step of the finance distribution plan, no more");
